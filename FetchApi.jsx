 ...
 <p style={{textAlign:"center",fontWeight:"bold"}}> Card Id: {item.id} </p>
  ...
  <ul style={{display:"flex",listStyle:"none",justifyContent:"space-around", height:'30px',backgroundColor:"black", color:'white',textDecoration:"none",alignItems:"center",position:"fixed",bottom:"0",width:"98%", padding:"5px"}}>
    <li className='page-item' >
      <a  onClick={(e)=>perPage(e)} className='link' style={{ color: 'whitesmoke',textDecoration:"none", cursor:"grab"}}>Prev</a>
    </li>
    {
      numbers.map((n,i)=>(
          <>
            <li className={`page-item ${currentPage === n ? "active" : " "}`} key={i}>
              <a onClick={(e)=>changeCurrentP(n,e)} style={{ color: 'whitesmoke',textDecoration:"none", cursor:"grab"}} className='link'>{n}</a>
            </li>
          </>
        )
      )
    ...
    <li className='page-item'>
      <a  onClick={(e)=>nextPage(e)} style={{ color: 'whitesmoke',textDecoration:"none", cursor:"grab"}}className='link'>Next</a>
    </li>
  </ul>
</nav>
      </div>
